      ...
      <div className="col-md-8">
        <div className="input-icon margin-top-10">
          ...
          >
            ...
            {!mostrarMiniPreview ? <img alt="" src={`${masterPath.url}/files/institucional/${props.codImg}`} width={50} style={{ fontSize: "15px" }} /> : ""}
            {!mostrarMiniPreview ? <a href={`${masterPath.url}/files/institucional/${props.codImg}`} target="_blank" rel="noopener noreferrer" className="pull-right d-flex" id="btnVerImagem" title="verimagem">Ver imagem</a> : ""}
            ...
            {imagem ? <a href={`${masterPath.url}/files/institucional/${imagem.name}`} target="_blank" rel="noopener noreferrer" className="pull-right d-flex" id="btnVerImagem" title="verimagem">Visualizar</a> : ""}
