            ...
            <div className="header hidden-print" style={
                ...
                <div className="container">
                    <div className="container-mosaico">
                        ...
                        {props.logoTop ? <a href={import.meta.env.VITE_BASE_URL + '/'}><img alt="" src="/assets/img/logo.png" className="logo" /></a> : ''}
                        <div className="pull-right faixa-header">
                            <ul className="header-navigation">
                                <li className="assine"><a href={import.meta.env.VITE_BASE_URL + '/comprar-espaco-minisitio'}>Assine Agora</a></li>
